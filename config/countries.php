...
return [
    ...
    array('name' => 'Colombia'),
    array('name' => 'Comoros'),
    array('name' => 'Congo Republic of the'),
    array('name' => 'Congo Democratic Republic of the'),
    array('name' => "Costa Rica Cote d'Ivoire"),
    array('name' => 'Croatia'),
    array('name' => 'Cuba'),
    array('name' => 'Cyprus'),
    ...
    array('name' => 'Russia'),
    array('name' => 'Rwanda'),
    array('name' => 'St. Kitts and Nevis'),
    array('name' => 'St. Lucia'),
    array('name' => 'St. Vincent and The Grenadines'),
    array('name' => 'Samoa'),
